...
"resource": {
  ...
  "rules":[
    [["if",2],["unless",0,1],["add",0,5,10,11,12,13,14,15,16,17,23,28,30,31,32]],
    [["if",4,15,16],["unless",1],["add",1,8,10,16,25],["block",21,31]],
    [["if",4,17],["unless",1],["add",2,4,10,16,20,24,31]],
    [["if",4,18],["unless",1],["add",3,7,10,16,20,26,29,31]],
    [["if",22,23],["add",6,9,10,16,20,26,27,29,31]],
    [["if",23,24],["add",7,20,26,29]],
    [["if",23,25],["add",18]],
    [["if",23,26],["add",19]],
    [["if",23,27],["add",21]],
    [["if",23],["add",22]],
    [["if",3,4],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,21,23,24,25,26,28,29,30,31,32]],
    [["if",4,5],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,21,23,24,25,26,28,29,30,31,32]],
    [["if",4,6],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,21,23,24,25,26,28,29,30,31,32]],
    [["if",4,7],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,21,23,24,25,26,28,29,30,31,32]],
    [["if",4,8],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,21,23,24,25,26,28,29,30,31,32]],
    [["if",4,9],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,21,23,24,25,26,28,29,30,31,32]],
    [["if",4,10],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,21,23,24,25,26,28,29,30,31,32]],
    [["if",4,11],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,21,23,24,25,26,28,29,30,31,32]],
    [["if",4,12],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,21,23,24,25,26,28,29,30,31,32]],
    [["if",4,13],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,21,23,24,25,26,28,29,30,31,32]],
    [["if",4,14],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,21,23,24,25,26,28,29,30,31,32]],
    [["if",4,19],["block",3,7,10,16,20,21,26,28,29,30,31]],
    [["if",4,20],["block",3,7,10,16,20,21,26,28,29,30,31]],
    [["if",4,21],["block",3,7,10,16,20,21,26,28,29,30,31]]]
},
"runtime":[
[],[]
]
...
aj=function(a,b,c){return qf(a,b,void 0===c?!0:!!c)},bj=function(a,b){if(xd()){b&&G(b)}else Yb(a,b)},cj=function(a){return!!Rg(a,"init",!1)},dj=function(a){Pg(a,"init",!0)},ej=function(a,b,c){var d=(void 0===c?0:c)?"www.googletagmanager.com/gtag/js":Ec;d+="?id="+encodeURIComponent(a)+"&l=dataLayer";b&&za(b,function(e,g){g&&(d+="&"+e+"="+encodeURIComponent(g))});R(P("https://","http://",d))},fj=function(a,b){var c=a[b];return c};var gj=Kg.Fg;var hj=new xa,ij=function(a,b){function c(h){var k=Be(h),l=Ae(k,"protocol"),m=Ae(k,"host",!0),n=Ae(k,"port"),q=Ae(k,"path").toLowerCase().replace(/\/$/,"");if(void 0===l||"http"==l&&"80"==n||"https"==l&&"443"==n)l="web",n="default";return[l,m,n,q]}for(var d=c(String(a)),e=c(String(b)),g=0;g<d.length;g++)if(d[g]!==e[g])return!1;return!0},kj=function(a){
return jj(a)?1:0};
